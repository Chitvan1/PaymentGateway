...
import com.paymentSystem.razorpay.common.exceptions.InvalidStateTransitionException;
...
public class PaymentStateMachine {
    ...
    private static final Map<Transition, PaymentStatus> TRANSITION = Map.ofEntries(
            ...
            Map.entry(new Transition(PaymentStatus.CAPTURED, PaymentEvent.REFUND_INITIATE), PaymentStatus.PARTIALLY_REFUNDED),
            ...
            Map.entry(new Transition(PaymentStatus.SETTLED, PaymentEvent.REFUND_INITIATE), PaymentStatus.PARTIALLY_REFUNDED),
